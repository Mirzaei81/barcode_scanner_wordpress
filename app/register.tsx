...
import {Text,Checkbox, Button, TextInput, ActivityIndicator} from "react-native-paper"
            ...
            <View style={{height:"100%",backgroundColor: Color.light.background}}>
                ...
                <ScrollView style={{flex:1,backgroundColor:"white",margin:20,direction:"rtl",padding:10}}>
                    ...
                    <Text style={{fontSize:36,fontWeight:"800",marginBottom:20}}>عضویت</Text>
                        ...
                        <TextInput cursorColor={Colors.light.secondary} contentStyle={{backgroundColor:"white",borderRadius:10,borderColor:"grey",borderWidth:1}} outlineStyle={{borderRadius:10,borderColor:"grey",borderWidth:10}}  mode="outlined"  onChangeText={(s)=>setName(s)}/>
                        <View style={{backgroundColor:"white", alignSelf: 'flex-start', borderBottomColor: 'black',paddingBottom:3, borderBottomWidth: 3,marginBottom:8 }}>
                    ...
                    <View style={{ direction: "ltr",backgroundColor:"white"}}>
                        ...
                        {loading ? <Button disabled={true} onTouchStart={onSubmit} style={{ borderRadius: 5 }} textColor="#fefdf4ff" buttonColor="#1c2434ff" mode="contained" ><ActivityIndicator color={Colors.light.secondary} /></Button> :
